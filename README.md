TODELETE: Внимание, если вы читаете это, то смотрите до дедлайна 8 числа. Я случайно нажал "ответить"(( Задание выполнено, но возможно немного модифицируется до 8 числа
